...
namespace DormInfrastructure.Controllers
{
    ...
    public class DegreesController : Controller
    {
        ...
        public DegreesController(Do2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Students", new { id = degree.Id, name = degree.DegreeName });
        }
        ...
        public async Task<IActionResult> Create([Bind("DegreeName,Id")] Degree degree)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DegreeName,Id")] Degree degree)
        {
            if (id != degree.Id)
            {
                return NotFound();
