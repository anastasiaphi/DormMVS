...
namespace DormInfrastructure.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Address,Email,Id")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Address,Email,Id")] Faculty faculty)
        {
            if (id != faculty.Id)
            {
                return NotFound();
